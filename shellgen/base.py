...
class meta_shellcode(type):
    ...
    def __init__(cls, name, bases, namespace):
        ...
        try:
            ...
            # Autogenerate a unique name for the shellcode.
            meta_autoname(cls)
...
class Shellcode (object):
    ...
    # Default name if the class doesn't override it.
    @property
    def name(self):
...
class Raw (Static):
    ...
    @classmethod
    def from_dump(self, input, arch = 'any', os = 'any',
                 requires  = None, provides = None,
                 qualities = None, encoding = None):
        """
        ...
        return cls(bytes, arch, os, requires, provides, qualities, encoding)

    @classmethod
    def from_source(self, input, arch = 'any', os = 'any',
                 requires  = None, provides = None,
                 qualities = None, encoding = None):
        """
